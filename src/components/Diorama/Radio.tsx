...
const Radio: React.FC<RadioProps> = ({
    ...
    useEffect(() => {
        ...
        const musicAudio = new Audio(`${import.meta.env.BASE_URL}assets/sounds/ms_jackson.mp3`);
        ...
        const clickAudio = new Audio(`${import.meta.env.BASE_URL}/assets/sounds/click.mp3`);
    ...
    return (
        ...
        >
            <img
                src={`${import.meta.env.BASE_URL}assets/radio.png`}
                alt="Radio"
